...
gulp.task('mooveLib', function(){
	gulp.src(['./project/style/*.css', '!./project/style/password*.css'])
	    .pipe(gulp.dest('./public/style')); 
	gulp.src(['./project/script/*.js', "!./project/script/password*.js"])
...
gulp.task('changeMainTS', function () {
	gulp.src(['./project/script/password.ts'])
        .pipe(gulpTS())  
        .on('error', console.log) 
...
gulp.task('whatsNew', function(){
	...
	watch('./project/script/password.ts', function(event) {  
